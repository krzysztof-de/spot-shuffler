...
import { BookingInputProps } from "../booking/BookingDetails";
import jsPDF from "jspdf";
import html2canvas from "html2canvas";

const Invoice = ({ data }: BookingInputProps) => {
        ...
        <div id="booking_invoice" className="px-4 border border-secondary">
          ...
          <main>
            <table className="mt-5">
              <thead>
                <tr>
                  <th className="service">Place</th>
                  <th className="desc">Price Paid</th>
                  <th>Check In Date</th>
              ...
              <tbody>
                <tr>
                  ...
                  <td className="desc">{booking?.place?.price?.adults} PLN</td>
                  <td className="unit">
                ...
                <tr>
                  ...
                  <td className="grand total">{booking?.amountPaid} PLN</td>
                </tr>
              </tbody>
            </table>
            <div id="notices">
